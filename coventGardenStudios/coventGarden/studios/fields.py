...
# CustomGroup
MODEL_GROUP_NAME = models.CharField(max_length=LENGTH_NAME, verbose_name=LABEL_GROUP_NAME)
MODEL_GROUP_EMAIL = models.EmailField(max_length=LENGTH_EMAIL, verbose_name=LABEL_EMAIL)
MODEL_GROUP_PHONE = models.CharField(max_length=LENGTH_PHONE, verbose_name=LABEL_PHONE, validators=[phone_validator])
MODEL_MEMBERS = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(20)], verbose_name=LABEL_MEMBERS, default=1)
MODEL_GENRE = models.CharField(max_length=LENGTH_NAME, verbose_name=LABEL_GENRE)
MODEL_FACEBOOK = models.URLField(max_length=LENGTH_URL, verbose_name=LABEL_FACEBOOK, blank=True)
MODEL_INSTAGRAM = models.URLField(max_length=LENGTH_URL, verbose_name=LABEL_INSTAGRAM, blank=True)
MODEL_BIOGRAPHY = models.TextField(max_length=LENGTH_TEXT, verbose_name=LABEL_BIOGRAPHY, blank=True)
MODEL_TECHNICAL_SHEET = models.FileField(upload_to=MEDIA_PATH, verbose_name=LABEL_TECHNICAL_SHEET, blank=True)
MODEL_LOGO = models.FileField(upload_to=MEDIA_PATH, verbose_name=LABEL_LOGO, blank=True)
